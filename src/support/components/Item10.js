        ...
        <div className={accordionClasses.root}>
            ...
            <Accordion>
                ...
                <AccordionDetails>
                    <ol>
                        ...
                        <ul>
                            <li class="checkbox_section"><SupportRedCheckBox /><SupportCheckBox />Fatura</li>
                ...
                <AccordionDetails>
                    <ol>
                        ...
                        <ul>
                            ...
                            <li class="checkbox_section"><SupportRedCheckBox /><SupportCheckBox /><b>HARCAMA GİRİŞİ EKRANINDA EKLİ KISMINDA</b> ödeme belgeisne ilişkin belegeler bulunabiliyor. Bu kısmı kontrol et.</li>
                        </ul>
            ...
            <Accordion>
                ...
                <AccordionDetails>
                    <ol>
                        ...
                        <li class="checkbox_section"><SupportRedCheckBox /><SupportCheckBox customLabel="Danışmanlık hizmeti kapsamında ULAŞIM VE KONAKLAMA giderleri desteklenmez. Sözleşmede/Fatura böyle bir ifade var mı?" /></li>
                        <li class="checkbox_section"><SupportRedCheckBox /><SupportCheckBox customLabel="YURT İÇİ YASAL ZORUNLULUKLAR nedeniyle alınan DANIŞMANLIK, YAZILIM ve DONANIM harcamaları desteklenmez. Sözleşme kontrol" /></li>
            ...
            <Accordion>
                ...
                <AccordionDetails>
                    <ol>
                        ...
                        <li>Danışmanlık/Genel Limitler Kontrol Tablosunun hazırlanması</li>
                ...
                <AccordionDetails>
                    <ol>
                        ...
                        <ul>
                            ...
                            <li>Fatura, Sözleşme, Ödeme, Harcama Girişi ekranlarındaki tüm uygun ekleri "onaylı", uygun olmayanları "reddedildi" hale getir</li>
                            <li>Bu ekranda <b>DESTEK TUTARI (TL)</b> alanı doldurulur. "Destek USD" kısmı ve diğer bilgileri sistem otomatik olarak hesaplıyor. "Destek Tutarı (TL) alanına yazılan tutar firmaya verilecek desteğin %50 ve ortaklık payına bölünmemiş halidir. Yani ödenecek desteğin hesaplanacağı tutardır. Firmaya ödenecek tutar hemen yan kısımda "Ödeme Tutarı" alanında sistemden tarafından otomatik olarak yazılır. </li>
                            <li><img src={require('../images/exclamation_mark.png')} />Destek Tutarı (TL) alanına <b>FATURA TUTARI (TL) veya ÖDEME TUTARI (TL)'NDAN HANGİSİ DAHA KÜÇÜKSE</b> o yazılır. Çünkü döviz ile kesilmiş olan faturalarda kur farkından dolayı faturanın kesildiği tarih ile ödeme belgesi tarihindeki TL tutarları değişiklik göstrebiliyor. Kamu kaynaklarının verimli kullanımı anlamında bu yöntem tercih ediliyor.</li>
                            ...
                            <li><img src={require('../images/exclamation_mark.png')} />Firmanın aldığı hizmetin Bakanlık tarafından <u>onaylanmamış</u> olan bir iştariki tarafından alındığı anlaşılırsa (bu durum genelde sözleşmelerde yazıyor) firmanın hizmet alan <b>ONAYLI İŞTİRAKLERİ ORANINDA DESTEK TUTARI</b> yazılır. Örnek: 5 firmanın 4'ü onaylı 1'i reddedilmişse destek tutarı 4/5 oranında yazılır ve açıklama kısmına bu durum belirtilir. Onaylanan iştiraklerin ortaklık payı bu hesaplama yapılırken dikkate alınmaz. Yani iştiraklerin ortaklık payı %100'ün altında olsa bile 4/5 oranında hesaplama yapılır.</li>
                            ...
                            <li><b>AÇIKLAMA</b> kısmına ilgili harcama için açıklama yazılır. Örnek:Danışmanlıkta “Hedef Ülkeler desteklenmiştir” yazılıyor. Kısca neyin desteklendiği yazılıyor. Ödeme belgesindeki tutarın aynı olmaması gibi özel durumlarda buraya destek tutarının nasıl hesaplandığına ilişkin mutlaka açıklama yazılmalıdır.</li>
                ...
                <AccordionDetails>
                    <ol>
                        ...
                        <ul>
                            ...
                            <li>Bu tabloya eklenecek bilgiler BI Publisher Belgesi'nden alınır.</li>
            ...
            <Accordion>
                <AccordionSummary
                    ...
                    id="panel12a-header">
                    <Typography className={accordionClasses.heading}>11) Genel Limitler / Danışmanlık Limit Kontol Tablosu | <TimeCounter /></Typography>
                </AccordionSummary>
                ...
                <AccordionDetails>
                    <ol>
                        ...
                        <ul>
                            ...
                            <li>Aynı tabloda <b>DANIŞMANLIK</b> sekmesi de yer alıyor. Danışmanlık için ise limit farklı <b>600.000 USD</b>’dir. 600.000 USD’yi aşmaması gerekiyor. Danışmanlıkta yıl hesabı yapılmıyor. Firmanın sisteme (destek dönemi başlangıcı) giriş tarihinden itibaren 365 gün içinde yaptığı harcamalar dikkate alınıyor. Danışmanlık <b>ÖDEME BELGESİ TARİHİ</b> dikkate alınır 1 yıl hesaplamasında.</li>
                            <li>Danışmanlık harcamaları toplam 20 milyon TL’lik limite dahil ediliyor toplam limit hesaplaması yapılırken. Danışmanık bir de ayrıca tutuluyor 600.000 USD limiti geçmemesi için.</li>
                            ...
                            <li>Ayda 2 defa Turquality Sekreterya'dan sistemdeki tüm verilere ilişkin güncel <b>EXCEL RAPORU</b> geliyor. Bu Excel raporunda gerekli filtrelemeleri yaparak o güne kadarki genel ve danışmanlık harcamaları tespit edilebilir. Bu tablo en doğru tablodur. Kendi verilerini bu tablo ile kontrol ederek Genel/Danışmanlık Limit Tablosunun sürekli güncel tutulması çok önemlidir.</li>
                        </ul>
                    </ol>
                ...
                <AccordionDetails>
                    <ol>
                        ...
                        <ul>
                            ...
                            <li>Harcama dosya no, Birlik başvuru no ve Evrak No aynı şeylerdir.</li>
                ...
                <AccordionDetails>
                    <ol>
                        ...
                        <ul>
                            ...
                            <li>BI Publisher, hakediş tablosu, hesap takip tablosu ve genel/danışmanlık limit kontrol tablosu Home Ofis klasörü içinde Şube Müdürü'nün imzasına klasörüne eklenir (Vekalet verildiyse Şube Şefleri de olabilir). Örnek klasör ismi: MARKA İSMİ 1.475,00 TL</li>
